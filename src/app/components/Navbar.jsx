...
export default function Navbar() {
  ...
  return (
    <div>
        <nav className='bg-transparent flex flex-row justify-between px-3 md:px-6 h-12 items-center'>
            <div>
              <FaContao className='text-3xl text-[gold]' />

            </div>
            <div>
            <ul className={`bg-white md:bg-transparent md:text-white md:gap-9    md:relative md:flex md:flex-row flex flex-col fixed h-[100vh] md:h-[100%] w-[100%] left-0 items-center justify-around ${showNav ? 'flex' : 'hidden'}`}>
